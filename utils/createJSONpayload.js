const vingenerator = require('../utils/randomVIN')
const fakevin= require('@faker-js/faker')


let randomVIN= new vingenerator();
let vin= randomVIN.fakevinGen()
